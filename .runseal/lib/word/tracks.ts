 ...
 */
const WIRE_PATH =
  /(?:^|\/)(?:model(?:\/|\.rs$)|server\/(?:openapi|routes|sse|im|effects|errors|error\.rs$)|webhook(?:\/|\.rs$)|provider\.rs$|openai(?:\/|\.rs$)|chat\/completions(?:\/|\.rs$)|cli(?:\/|\.rs$)|config(?:\/|\.rs$)|ops\.rs$|upgrade(?:\/|\.rs$)|santi-object\/|object\/store\.rs$|santi-error\/|store\/(?:db(?:\/|\.rs$)|schema\.rs$|rows(?:\/|\.rs$))|store(?:\.rs|\/(?:mod|souls)\.rs)$)/;
